...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "Refresh Graph": {"zh": "刷新 ROS 图", "en": "Refresh Graph"},
    ...
    "CALVIN Layout": {"zh": "CALVIN 布局", "en": "CALVIN Layout"},
    ...
    "Run Layout Checks": {"zh": "运行布局检查", "en": "Run Layout Checks"},
    ...
    "Use the top toolbar Refresh Graph button to update the global ROS graph.": {
        "zh": "使用顶部工具栏的刷新 ROS 图按钮更新全局 ROS 图。",
        "en": "Use the top toolbar Refresh Graph button to update the global ROS graph.",
    },
