...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "Project Info": {"zh": "项目信息", "en": "Project Info"},
    ...
    "Refresh ROS Graph": {"zh": "刷新 ROS 图", "en": "Refresh ROS Graph"},
    ...
    "Use the top toolbar Refresh ROS Graph button to update the global ROS graph.": {
        "zh": "使用顶部工具栏的刷新 ROS 图按钮更新全局 ROS 图。",
        "en": "Use the top toolbar Refresh ROS Graph button to update the global ROS graph.",
    },
