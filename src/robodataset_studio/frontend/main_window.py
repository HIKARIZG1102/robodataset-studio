...
from robodataset_studio.frontend.backend_process import BackendProcess
from robodataset_studio.frontend.i18n import apply_i18n, normalize_language, set_source_text, text
from robodataset_studio.frontend.pages.collect_page import CollectPage
from robodataset_studio.frontend.pages.convert_page import ConvertPage
from robodataset_studio.frontend.pages.logs_page import LogsPage
from robodataset_studio.frontend.pages.project_page import ProjectPage
from robodataset_studio.frontend.pages.review_page import ReviewPage
from robodataset_studio.frontend.pages.ros_page import RosPage
from robodataset_studio.frontend.pages.settings_page import SettingsPage
from robodataset_studio.frontend.pages.tutorial_page import TutorialPage
from robodataset_studio.frontend.pages.upload_page import UploadPage
from robodataset_studio.frontend.widgets.config_library_page import ConfigLibraryPage
from robodataset_studio.frontend.widgets.inspector import InspectorDock
from robodataset_studio.frontend.widgets.project_config_page import ProjectConfigPage
from robodataset_studio.frontend.widgets.project_dialog import NewProjectDialog
...
class MainWindow(QMainWindow):
    ...
    def open_html_guide(self) -> None:
        guide = Path(__file__).resolve().parents[3] / "RoboDataset-Studio-Guide.html"
        if guide.exists():
