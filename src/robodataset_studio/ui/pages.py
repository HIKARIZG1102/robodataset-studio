...
class ReviewPage(QWidget):
    def __init__(self, ctx: AppContext) -> None:
        ...
        episode_layout.addLayout(target_row)
        episode_layout.addWidget(self.session_summary)
        controls = QHBoxLayout()
        ...
        episode_layout.addLayout(controls)
        episode_layout.addWidget(QLabel("Quality Summary"))
        episode_layout.addWidget(self.summary)
        ...
        tabs.addTab(hdf5_page, "HDF5 Inspect")
        tabs.addTab(layout_page, "CALVIN Layout")
