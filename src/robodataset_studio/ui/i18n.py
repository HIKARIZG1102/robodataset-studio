...
TEXTS: TextMap = {
    ...
    "Name": {"zh": "名称", "en": "Name"},
    "New Config": {"zh": "新建配置", "en": "New Config"},
    "Load From Library": {"zh": "从配置库加载", "en": "Load From Library"},
    "Save To Library": {"zh": "保存到配置库", "en": "Save To Library"},
    "Delete Library Config": {"zh": "删除库配置", "en": "Delete Library Config"},
    "Generate Default": {"zh": "生成默认配置", "en": "Generate Default"},
